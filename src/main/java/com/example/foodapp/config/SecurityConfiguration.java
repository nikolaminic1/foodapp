...
//                                .authenticated()
                        ...
                        .requestMatchers(builder.pattern("/api/v1/customer/**")).permitAll()
                        .requestMatchers(builder.pattern("/api/v1/owner/**")).permitAll()
                        .requestMatchers(builder.pattern("/api/v1/media/**")).permitAll()
